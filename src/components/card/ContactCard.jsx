...
export class ContactCard extends Component {
  render() {
    ...
    return (
      <div className="w-100 mt-3 border border-primary rounded-3 pt-3 pb-3 px-3 align-items-center row cursor-pointer">
        ...
        <p className="col-5 fs-5 text-primary text-underline text-decoration-underline m-0">
          {phone}
        </p>
        <div className="d-flex gap-3 col-2">
          <Button onClick={() => editContact(id)} type="submit">
            Edit
          </Button>
          <Button
